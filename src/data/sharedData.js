...
export const normalizeSharedData = (value) => {
  ...
  return {
    ...
    academic: {
      ...
      profiles: asArray(academic.profiles),
    },
    expenses: asArray(
    ...
    requests: asArray(data.requests),
    applications: asArray(data.applications),
    documents: asArray(data.documents),
    aiSearchHistory: asArray(data.aiSearchHistory),
    reminders: asArray(data.reminders),
